...
MODEL_CLASSES = {
    ...
    # 'bert': (BertConfig, BertLstmCrf, AutoTokenizer),
...
def predict(args, model, tokenizer, prefix=""):
    ...
    if args.task_name == 'ccks':
        output_submit_file = os.path.join(pred_output_dir, prefix, "test_submit_checkpoint_40_data_0.json")
        test_text = []
...
def main():
    ...
    parser.add_argument("--linear_learning_rate", default=2e-5, type=float,
                        help="The initial learning rate for Adam.")
    parser.add_argument("--learning_rate", default=2e-5, type=float,
                        help="The initial learning rate for Adam.")
    parser.add_argument("--crf_learning_rate", default=2e-4, type=float,
    ...
    if args.do_predict:
        ...
        checkpoints = [os.path.join(args.output_dir, path) for path in os.listdir(args.output_dir)]
        # checkpoints = [path for path in checkpoints if os.path.isdir(path)]
        checkpoints=["/home/linh/ccf_0/ner-copy/ccks2020-ner/outputs/ccf_roberta_0/bert/best_checkpoint_40"]
